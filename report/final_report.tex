...
\begin{enumerate}
  ...
  \item The first layer, we first perform feature extraction on the input using 2-dimensional convolutions to learn the edges and color gradients.
